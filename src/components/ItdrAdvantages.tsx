...
const DATA: Record<string, Data> = {
  en: {
    ...
    lead: 'A SOC alerts and waits for a human. ITDR detects, decides and responds on its own — and responds to the attack through lawful channels, only ever within doctrine and with your approval.',
    stats: [
    ...
    rows: [
      ...
      ['Response', 'rare, manual, legal hesitation', 'graduated L1–L4, ROE-gated, lawful, automatic'],
  ...
  ru: {
    ...
    lead: 'SOC шлёт алерт и ждёт человека. ITDR сам обнаруживает, решает и отвечает — и реагирует на атаку законными каналами, но только по доктрине и с вашего одобрения.',
    stats: [
    ...
    rows: [
      ...
      ['Противодействие', 'редко, вручную, юридические колебания', 'градуированно L1–L4, по ROE, законно, автоматически'],
      ...
      ['Обучение', 'изредка пост-мортем', 'каждый инцидент → доктрина, каждый ответ умнее'],
  ...
  zh: {
    h: '平台 vs 資安團隊',
    lead: 'SOC 只發告警、等待人工。ITDR 自行偵測、裁決並回應——並對攻擊依法回應，但僅在守則允許且取得您的授權之下。',
    stats: [
  ...
  de: {
    ...
    rows: [
      ...
      ['Reaktion', 'selten, manuell, rechtliches Zögern', 'gestuft L1–L4, ROE-gesteuert, rechtmäßig, automatisch'],
  ...
  es: {
    ...
    rows: [
      ...
      ['Aprendizaje', 'un post-mortem ocasional', 'cada incidente → doctrina, cada respuesta más inteligente'],
  ...
  it: {
    ...
    rows: [
      ...
      ['Apprendimento', 'un post-mortem occasionale', 'ogni incidente → dottrina, ogni risposta più intelligente'],
  ...
  ja: {
    ...
    rows: [
      ...
      ['対応', '稀・手動・法的躊躇', '段階的L1〜L4、ROE管理、合法、自動'],
  ...
  uk: {
    ...
    lead: 'SOC надсилає алерт і чекає людину. ITDR сам виявляє, вирішує і відповідає — і реагує на атаку законними каналами, але лише за доктриною і з вашого схвалення.',
    stats: [
    ...
    rows: [
      ...
      ['Протидія', 'рідко, вручну, юридичні вагання', 'градуйовано L1–L4, за ROE, законно, автоматично'],
      ...
      ['Навчання', 'зрідка пост-мортем', 'кожен інцидент → доктрина, кожен відповідь розумніший'],
  ...
  sr: {
    ...
    rows: [
      ...
      ['Odgovor', 'retko, ručno, pravna neizvesnost', 'stepenovano L1–L4, kontrolisano ROE, zakonito, automatski'],
  ...
  pt: {
    ...
    lead: 'Um SOC alerta e espera por um humano. O ITDR deteta, decide e responde sozinho — e responde ao ataque por vias legais, sempre dentro da doutrina e com a sua aprovação.',
    stats: [
    ...
    closing: 'Velocidade de máquina e disciplina de soldado — só responde quando a doutrina permite. A linha nunca dorme.',
  },
  hi: {
    ...
    rows: [
      ...
      ['प्रतिक्रिया', 'दुर्लभ, मैनुअल, कानूनी हिचकिचाहट', 'चरणबद्ध L1–L4, ROE-नियंत्रित, वैध, स्वचालित'],
  ...
  ar: {
    ...
    rows: [
      ...
      ['الاستجابة', 'نادر، يدوي، تردد قانوني', 'متدرج L1–L4، محكوم بقواعد الاشتباك، قانوني، آلي'],
